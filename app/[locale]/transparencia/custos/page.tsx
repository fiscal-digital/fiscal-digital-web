...
// ISR: revalida a cada 1h. FiscalCustos roda 1×/dia (06:00 UTC).
// Regeneração imediata via webhook /api/revalidate (ISR-WEB-002 Sprint 6).
// Para já: 1h é suficiente (primeira visita após Lambda rodar regenera).
